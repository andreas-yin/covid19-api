...
export const DATAPOINT_NOT_FOUND =
  "Datapoint not found. Datapoint value has to be a specific string, e.g. 'cases', 'todayCases', 'deaths' or 'todayDeaths'. Camel, Pascal, snake or kebap case or spaces between words required.";
