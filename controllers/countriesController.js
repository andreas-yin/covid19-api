...
const sendData = async (req, res) => {
    try {
        ...
        //Requests with a query parameter of 'datapoint' following the country receive the specified datapoint only
        //E.g. /countries/Germany?datapoint=today-cases returns today's cases in Germany only
